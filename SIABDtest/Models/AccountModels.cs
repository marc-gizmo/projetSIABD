...
namespace projetSIABD.Models
{
    ...
    public class UserModel
    {
        ...
        [Required]
        [DisplayName("Données de l'utilisateur")]
    ...
    public interface IMembershipService
    {
        ...
        bool EditUser(my_aspnet_membership model);
    }
    ...
    public class AccountMembershipService : IMembershipService
    {
        ...
        public bool EditUser(my_aspnet_membership model)
        {
            if (model == null) throw new ArgumentException("La valeur ne peut pas être null ou vide.", "model");
            ...
            membership.Comment = model.Comment;
            membership.IsApproved = model.IsApproved;
            membership.IsLockedOut = model.IsLockedOut;
